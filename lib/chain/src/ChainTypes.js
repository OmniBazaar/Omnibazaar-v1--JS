...
ChainTypes.operations = {
    ...
    welcome_bonus_operation: 47,
    referral_bonus_operation: 48,
    sale_bonus_operation: 49,
    founder_bonus_operation: 50,
    witness_bonus_operation: 51,
    escrow_create_operation: 52,
    escrow_release_operation: 53,
    escrow_return_operation: 54,
    omnibazaar_multisig_transfer: 55,
    omnibazaar_listing_create: 56,
    omnibazaar_listing_update: 57,
    omnibazaar_listing_delete: 58
};
